...
from src.pneumoniaDisease.ml.model.arch import Net
from src.pneumoniaDisease.constants import *
from src.pneumoniaDisease.entity.config_entity import ModelTrainerConfig
from src.pneumoniaDisease.entity.artifact_entity import DataTransformationArtifact, ModelTrainerArtifact
    ...
    def train(self, optimizer: Optimizer)->None:
        ...
        try:
            ...
            for batch_idx, (data, target) in enumerate(pbar):
                ...
                processed+=len(data)
                pbar.set_description(desc=f"{loss.item()} Batch_id= {batch_idx} Accuracy={100*correct/processed:0.2f}")
